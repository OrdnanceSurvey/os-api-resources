...
| <a name="api-authentication">API Authentication</a> | Discussion around the options (and best practices) for authenticating requests when using the OS Data Hub APIs. | https://labs.os.uk/public/os-api-resources/api-authentication | 
...
| <a name="osdatahub-python">osdatahub (Python)</a> | Designed to make data from the OS Data Hub APIs readily accessible to Python developers. | https://pypi.org/project/osdatahub/<br><br>https://github.com/OrdnanceSurvey/osdatahub (source code) |
| <a name="osdatahub-js">osdatahub (JavaScript)</a> | JavaScript package that makes it easier to interact with the OS Data Hub APIs. | https://www.npmjs.com/package/osdatahub |
